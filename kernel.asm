...
8010364c:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
  release(&ptable.lock);
80103652:	e8 29 0e 00 00       	call   80104480 <release>
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 d1 56 10 80 	movl   $0x801056d1,0x14(%eax)
  p->context = (struct context*)sp;
...
80103686:	e8 45 0e 00 00       	call   801044d0 <memset>
...
801036aa:	e8 d1 0d 00 00       	call   80104480 <release>
}
...
801036db:	e8 a0 0d 00 00       	call   80104480 <release>
...
801037ad:	68 88 75 10 80       	push   $0x80107588
...
80103823:	e8 78 34 00 00       	call   80106ca0 <setupkvm>
...
80103841:	e8 3a 31 00 00       	call   80106980 <inituvm>
...
801038e3:	e8 98 0b 00 00       	call   80104480 <release>
}
...
8010392c:	e8 3f 2f 00 00       	call   80106870 <switchuvm>
  return 0;
...
8010394a:	e8 71 31 00 00       	call   80106ac0 <allocuvm>
...
8010396a:	e8 81 32 00 00       	call   80106bf0 <deallocuvm>
...
801039b8:	e8 b3 33 00 00       	call   80106d70 <copyuvm>
...
80103a31:	e8 7a 0c 00 00       	call   801046b0 <safestrcpy>
  pid = np->pid;
...
80103a53:	e8 28 0a 00 00       	call   80104480 <release>
  return pid;
...
80103af0:	e8 7b 2d 00 00       	call   80106870 <switchuvm>
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 04 0c 00 00       	call   8010470b <swtch>
      switchkvm();
80103b07:	e8 44 2d 00 00       	call   80106850 <switchkvm>
      c->proc = 0;
...
80103b2c:	e8 4f 09 00 00       	call   80104480 <release>
    sti();
...
80103d69:	e8 12 07 00 00       	call   80104480 <release>
}
...
80103dc8:	e8 b3 06 00 00       	call   80104480 <release>
  p->chan = chan;
...
80103dea:	e8 91 06 00 00       	call   80104480 <release>
    acquire(lk);
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 42 2d 00 00       	call   80106c20 <freevm>
        release(&ptable.lock);
...
80103efe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f05:	e8 76 05 00 00       	call   80104480 <release>
        return pid;
...
80103f23:	e8 58 05 00 00       	call   80104480 <release>
      return -1;
...
80103f80:	c9                   	leave  
  release(&ptable.lock);
80103f81:	e9 fa 04 00 00       	jmp    80104480 <release>
...
80103fdb:	e8 a0 04 00 00       	call   80104480 <release>
      return 0;
...
80103ff8:	e8 83 04 00 00       	call   80104480 <release>
  return -1;
...
80104058:	8b 14 85 b0 75 10 80 	mov    -0x7fef8a50(,%eax,4),%edx
      state = "???";
...
80104098:	e8 e3 01 00 00       	call   80104280 <getcallerpcs>
...
801040d6:	eb 22                	jmp    801040fa <recursiveCall+0x2a>
801040d8:	90                   	nop
...
801040e7:	68 4d 75 10 80       	push   $0x8010754d
...
8010413a:	68 c8 75 10 80       	push   $0x801075c8
...
80104151:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104154:	c7 43 40 00 00 00 00 	movl   $0x0,0x40(%ebx)
  lk->name = name;
8010415b:	89 43 3c             	mov    %eax,0x3c(%ebx)
}
...
801041b1:	89 43 40             	mov    %eax,0x40(%ebx)
  release(&lk->lk);
...
801041bc:	5d                   	pop    %ebp
  release(&lk->lk);
801041bd:	e9 be 02 00 00       	jmp    80104480 <release>
...
801041e4:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801041ea:	c7 43 40 00 00 00 00 	movl   $0x0,0x40(%ebx)
  wakeup(lk);
...
80104204:	5d                   	pop    %ebp
  release(&lk->lk);
80104205:	e9 76 02 00 00       	jmp    80104480 <release>
...
80104230:	8b 5b 40             	mov    0x40(%ebx),%ebx
...
80104247:	e8 34 02 00 00       	call   80104480 <release>
  return r;
}
...
80104355:	68 d3 75 10 80       	push   $0x801075d3
8010435a:	e8 31 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010435f:	83 ec 0c             	sub    $0xc,%esp
80104362:	68 ea 75 10 80       	push   $0x801075ea
...
801043a5:	e8 26 ff ff ff       	call   801042d0 <pushcli>
  if (holding(lk)) {
801043aa:	8b 75 08             	mov    0x8(%ebp),%esi
...
801043bd:	ba 01 00 00 00       	mov    $0x1,%edx
801043c2:	74 0f                	je     801043d3 <acquire+0x33>
801043c4:	e9 87 00 00 00       	jmp    80104450 <acquire+0xb0>
801043c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801043d0:	8b 75 08             	mov    0x8(%ebp),%esi
  asm volatile("lock; xchgl %0, %1" :
801043d3:	89 d0                	mov    %edx,%eax
801043d5:	f0 87 06             	lock xchg %eax,(%esi)
...
801043dc:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
801043e1:	8b 75 08             	mov    0x8(%ebp),%esi
801043e4:	e8 57 f3 ff ff       	call   80103740 <mycpu>
  for(i = 0; i < 10; i++){
801043e9:	31 d2                	xor    %edx,%edx
  getcallerpcs(&lk, lk->pcs);
801043eb:	8d 4e 0c             	lea    0xc(%esi),%ecx
  lk->cpu = mycpu();
801043ee:	89 46 08             	mov    %eax,0x8(%esi)
  ebp = (uint*)v - 2;
801043f1:	89 e8                	mov    %ebp,%eax
801043f3:	90                   	nop
801043f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801043f8:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
801043fe:	81 fe fe ff ff 7f    	cmp    $0x7ffffffe,%esi
80104404:	77 22                	ja     80104428 <acquire+0x88>
    pcs[i] = ebp[1];     // saved %eip
80104406:	8b 70 04             	mov    0x4(%eax),%esi
80104409:	89 34 91             	mov    %esi,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
...
80104414:	75 e2                	jne    801043f8 <acquire+0x58>
  if (flag == 1)
80104416:	83 fb 01             	cmp    $0x1,%ebx
80104419:	74 27                	je     80104442 <acquire+0xa2>
}
8010441b:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010441e:	5b                   	pop    %ebx
8010441f:	5e                   	pop    %esi
80104420:	5d                   	pop    %ebp
80104421:	c3                   	ret    
...
80104436:	83 c0 04             	add    $0x4,%eax
  for(; i < 10; i++)
80104439:	39 c8                	cmp    %ecx,%eax
8010443b:	75 f3                	jne    80104430 <acquire+0x90>
  if (flag == 1)
8010443d:	83 fb 01             	cmp    $0x1,%ebx
80104440:	75 d9                	jne    8010441b <acquire+0x7b>
    popcli();
80104442:	e8 c9 fe ff ff       	call   80104310 <popcli>
}
...
80104450:	e8 8b f3 ff ff       	call   801037e0 <myproc>
80104455:	8b 1d 0c a0 10 80    	mov    0x8010a00c,%ebx
8010445b:	39 58 10             	cmp    %ebx,0x10(%eax)
8010445e:	75 0a                	jne    8010446a <acquire+0xca>
      flag = 1;
80104460:	bb 01 00 00 00       	mov    $0x1,%ebx
80104465:	e9 72 ff ff ff       	jmp    801043dc <acquire+0x3c>
      panic("acquire");
8010446a:	83 ec 0c             	sub    $0xc,%esp
8010446d:	68 f1 75 10 80       	push   $0x801075f1
...
8010448b:	e8 e0 fe ff ff       	call   80104370 <holding>
...
801044b3:	c9                   	leave  
  popcli();
801044b4:	e9 57 fe ff ff       	jmp    80104310 <popcli>
    panic("release");
801044b9:	83 ec 0c             	sub    $0xc,%esp
801044bc:	68 f9 75 10 80       	push   $0x801075f9
...
801047d5:	e8 06 f0 ff ff       	call   801037e0 <myproc>
...
801047e3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801047e6:	e8 f5 ef ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104828:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010482b:	e8 b0 ef ff ff       	call   801037e0 <myproc>
...
801048c4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801048c7:	e8 14 ef ff ff       	call   801037e0 <myproc>
...
801048dc:	8b 14 85 20 76 10 80 	mov    -0x7fef89e0(,%eax,4),%edx
...
80104900:	68 01 76 10 80       	push   $0x80107601
...
80104989:	66 83 7f 54 02       	cmpw   $0x2,0x54(%edi)
...
801049c9:	66 89 47 56          	mov    %ax,0x56(%edi)
  ip->minor = minor;
801049cd:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
801049d1:	66 89 47 58          	mov    %ax,0x58(%edi)
  ip->nlink = 1;
801049d5:	b8 01 00 00 00       	mov    $0x1,%eax
801049da:	66 89 47 5a          	mov    %ax,0x5a(%edi)
  iupdate(ip);
...
80104a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink++;  // for ".."
80104a40:	66 83 43 5a 01       	addw   $0x1,0x5a(%ebx)
    iupdate(dp);
...
80104a85:	68 8b 76 10 80       	push   $0x8010768b
...
80104a9a:	68 9a 76 10 80       	push   $0x8010769a
80104a9f:	e8 ec b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104aa4:	83 ec 0c             	sub    $0xc,%esp
80104aa7:	68 7c 76 10 80       	push   $0x8010767c
...
80104b29:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104b2b:	e8 b0 ec ff ff       	call   801037e0 <myproc>
...
80104c73:	78 2b                	js     80104ca0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104c75:	e8 66 eb ff ff       	call   801037e0 <myproc>
...
80104d61:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
80104d66:	0f 84 bb 00 00 00    	je     80104e27 <sys_link+0x127>
  ip->nlink++;
80104d6c:	66 83 43 5a 01       	addw   $0x1,0x5a(%ebx)
  iupdate(ip);
...
80104df8:	e8 83 c8 ff ff       	call   80101680 <ilock>
  ip->nlink--;
80104dfd:	66 83 6b 5a 01       	subw   $0x1,0x5a(%ebx)
  iupdate(ip);
...
80104e99:	58                   	pop    %eax
80104e9a:	5a                   	pop    %edx
80104e9b:	68 98 76 10 80       	push   $0x80107698
...
80104eb4:	68 97 76 10 80       	push   $0x80107697
...
80104ef1:	66 83 7b 5a 00       	cmpw   $0x0,0x5a(%ebx)
80104ef6:	0f 8e 10 01 00 00    	jle    8010500c <sys_unlink+0x1bc>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104efc:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80104f28:	0f 85 eb 00 00 00    	jne    80105019 <sys_unlink+0x1c9>
  if(ip->type == T_DIR){
80104f2e:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80104f3d:	e8 ce c9 ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
80104f42:	66 83 6b 5a 01       	subw   $0x1,0x5a(%ebx)
  iupdate(ip);
...
80104f70:	83 7b 5c 20          	cmpl   $0x20,0x5c(%ebx)
...
80104f83:	3b 7b 5c             	cmp    0x5c(%ebx),%edi
...
80104fcc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    dp->nlink--;
80104fd0:	66 83 6e 5a 01       	subw   $0x1,0x5a(%esi)
    iupdate(dp);
...
8010509b:	66 83 7e 54 01       	cmpw   $0x1,0x54(%esi)
...
801050af:	0f 84 a6 00 00 00    	je     8010515b <sys_open+0x12b>
  struct proc *curproc = myproc();
801050b5:	e8 26 e7 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105285:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105288:	e8 53 e5 ff ff       	call   801037e0 <myproc>
...
801052c9:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
8010545f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105461:	e8 7a e3 ff ff       	call   801037e0 <myproc>
...
80105487:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010548a:	e8 51 e3 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
801054c8:	e8 13 e3 ff ff       	call   801037e0 <myproc>
...
801055f0:	68 00 4e 11 80       	push   $0x80114e00
801055f5:	e8 a6 ed ff ff       	call   801043a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801055fa:	8b 55 f4             	mov    -0xc(%ebp),%edx
801055fd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105600:	8b 1d 40 56 11 80    	mov    0x80115640,%ebx
  while(ticks - ticks0 < n){
...
80105613:	68 00 4e 11 80       	push   $0x80114e00
80105618:	68 40 56 11 80       	push   $0x80115640
8010561d:	e8 5e e7 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
80105622:	a1 40 56 11 80       	mov    0x80115640,%eax
...
80105640:	68 00 4e 11 80       	push   $0x80114e00
...
80105663:	68 00 4e 11 80       	push   $0x80114e00
...
80105684:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105687:	68 00 4e 11 80       	push   $0x80114e00
8010568c:	e8 0f ed ff ff       	call   801043a0 <acquire>
  xticks = ticks;
80105691:	8b 1d 40 56 11 80    	mov    0x80115640,%ebx
  release(&tickslock);
80105697:	c7 04 24 00 4e 11 80 	movl   $0x80114e00,(%esp)
...
801056b3:	5d                   	pop    %ebp
  return recursiveCall();
801056b4:	e9 17 ea ff ff       	jmp    801040d0 <recursiveCall>
...
801056f0:	8b 14 85 10 a0 10 80 	mov    -0x7fef5ff0(,%eax,4),%edx
801056f7:	c7 04 c5 42 4e 11 80 	movl   $0x8e000008,-0x7feeb1be(,%eax,8)
801056fe:	08 00 00 8e 
80105702:	66 89 14 c5 40 4e 11 	mov    %dx,-0x7feeb1c0(,%eax,8)
80105709:	80 
8010570a:	c1 ea 10             	shr    $0x10,%edx
8010570d:	66 89 14 c5 46 4e 11 	mov    %dx,-0x7feeb1ba(,%eax,8)
80105714:	80 
  for(i = 0; i < 256; i++)
...
8010571f:	a1 10 a1 10 80       	mov    0x8010a110,%eax

  initlock(&tickslock, "time");
80105724:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105727:	c7 05 42 50 11 80 08 	movl   $0xef000008,0x80115042
8010572e:	00 00 ef 
  initlock(&tickslock, "time");
80105731:	68 dd 76 10 80       	push   $0x801076dd
80105736:	68 00 4e 11 80       	push   $0x80114e00
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010573b:	66 a3 40 50 11 80    	mov    %ax,0x80115040
80105741:	c1 e8 10             	shr    $0x10,%eax
80105744:	66 a3 46 50 11 80    	mov    %ax,0x80115046
  initlock(&tickslock, "time");
8010574a:	e8 11 eb ff ff       	call   80104260 <initlock>
}
...
8010576b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010576f:	b8 40 4e 11 80       	mov    $0x80114e40,%eax
...
801057c0:	e8 1b e0 ff ff       	call   801037e0 <myproc>
...
801057e0:	e8 db df ff ff       	call   801037c0 <cpuid>
...
801057f9:	e8 e2 df ff ff       	call   801037e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105815:	68 40 77 10 80       	push   $0x80107740
...
8010582e:	e8 ad df ff ff       	call   801037e0 <myproc>
80105833:	85 c0                	test   %eax,%eax
80105835:	74 1d                	je     80105854 <trap+0xc4>
80105837:	e8 a4 df ff ff       	call   801037e0 <myproc>
...
80105854:	e8 87 df ff ff       	call   801037e0 <myproc>
...
801058ad:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058b0:	e8 0b f0 ff ff       	call   801048c0 <syscall>
    if(myproc()->killed)
801058b5:	e8 26 df ff ff       	call   801037e0 <myproc>
...
8010594f:	e8 6c de ff ff       	call   801037c0 <cpuid>
80105954:	56                   	push   %esi
80105955:	53                   	push   %ebx
80105956:	50                   	push   %eax
80105957:	68 e8 76 10 80       	push   $0x801076e8
...
80105966:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105969:	e8 72 de ff ff       	call   801037e0 <myproc>
...
801059b3:	68 00 4e 11 80       	push   $0x80114e00
801059b8:	e8 e3 e9 ff ff       	call   801043a0 <acquire>
      wakeup(&ticks);
801059bd:	c7 04 24 40 56 11 80 	movl   $0x80115640,(%esp)
      ticks++;
801059c4:	83 05 40 56 11 80 01 	addl   $0x1,0x80115640
      wakeup(&ticks);
801059cb:	e8 60 e5 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
801059d0:	c7 04 24 00 4e 11 80 	movl   $0x80114e00,(%esp)
801059d7:	e8 a4 ea ff ff       	call   80104480 <release>
801059dc:	83 c4 10             	add    $0x10,%esp
801059df:	e9 09 ff ff ff       	jmp    801058ed <trap+0x15d>
801059e4:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801059e7:	e8 d4 dd ff ff       	call   801037c0 <cpuid>
...
801059f5:	68 0c 77 10 80       	push   $0x8010770c
801059fa:	e8 61 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
801059ff:	83 c4 14             	add    $0x14,%esp
80105a02:	68 e2 76 10 80       	push   $0x801076e2
...
80105afc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105aff:	bb 04 78 10 80       	mov    $0x80107804,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010666a:	e8 61 de ff ff       	call   801044d0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010670d:	68 0c 78 10 80       	push   $0x8010780c
...
801067c3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801067c6:	e8 f5 cf ff ff       	call   801037c0 <cpuid>
...
801067da:	c7 80 98 29 11 80 ff 	movl   $0xffff,-0x7feed668(%eax)
801067e1:	ff 00 00 
801067e4:	c7 80 9c 29 11 80 00 	movl   $0xcf9a00,-0x7feed664(%eax)
801067eb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801067ee:	c7 80 a0 29 11 80 ff 	movl   $0xffff,-0x7feed660(%eax)
801067f5:	ff 00 00 
801067f8:	c7 80 a4 29 11 80 00 	movl   $0xcf9200,-0x7feed65c(%eax)
801067ff:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106802:	c7 80 a8 29 11 80 ff 	movl   $0xffff,-0x7feed658(%eax)
80106809:	ff 00 00 
8010680c:	c7 80 ac 29 11 80 00 	movl   $0xcffa00,-0x7feed654(%eax)
80106813:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106816:	c7 80 b0 29 11 80 ff 	movl   $0xffff,-0x7feed650(%eax)
8010681d:	ff 00 00 
80106820:	c7 80 b4 29 11 80 00 	movl   $0xcff200,-0x7feed64c(%eax)
80106827:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010682a:	05 90 29 11 80       	add    $0x80112990,%eax
  pd[1] = (uint)p;
...
80106850:	a1 44 56 11 80       	mov    0x80115644,%eax
{
...
80106894:	0f 84 c2 00 00 00    	je     8010695c <switchuvm+0xec>
  pushcli();
8010689a:	e8 31 da ff ff       	call   801042d0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010689f:	e8 9c ce ff ff       	call   80103740 <mycpu>
801068a4:	89 c6                	mov    %eax,%esi
801068a6:	e8 95 ce ff ff       	call   80103740 <mycpu>
...
801068b8:	e8 83 ce ff ff       	call   80103740 <mycpu>
...
80106901:	e8 3a ce ff ff       	call   80103740 <mycpu>
...
80106919:	e8 22 ce ff ff       	call   80103740 <mycpu>
8010691e:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106924:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106927:	e8 14 ce ff ff       	call   80103740 <mycpu>
...
801069af:	e8 1c db ff ff       	call   801044d0 <memset>
...
801069e0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801069e1:	e9 9a db ff ff       	jmp    80104580 <memmove>
...
80106b0b:	e8 c0 d9 ff ff       	call   801044d0 <memset>
...
80106b4d:	68 89 78 10 80       	push   $0x80107889
...
80106cc0:	e8 0b d8 ff ff       	call   801044d0 <memset>
...
80106d2b:	a3 44 56 11 80       	mov    %eax,0x80115644
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106db0:	e8 cb d7 ff ff       	call   80104580 <memmove>
...
80106e49:	68 f2 78 10 80       	push   $0x801078f2
80106e4e:	e8 3d 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106e53:	83 ec 0c             	sub    $0xc,%esp
80106e56:	68 d8 78 10 80       	push   $0x801078d8
...
80106edf:	e8 9c d6 ff ff       	call   80104580 <memmove>
    len -= n;
    buf += n;
