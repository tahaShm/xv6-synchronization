...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 fb 78 10 80 	movl   $0x801078fb,(%esp)
...
80101ec8:	68 e2 76 10 80       	push   $0x801076e2
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
80103632:	a1 08 a0 10 80       	mov    0x8010a008,%eax
...
80103647:	68 c0 2e 11 80       	push   $0x80112ec0
  p->pid = nextpid++;
8010364c:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
  release(&ptable.lock);
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 11 57 10 80 	movl   $0x80105711,0x14(%eax)
  p->context = (struct context*)sp;
...
801037ad:	68 c8 75 10 80       	push   $0x801075c8
...
8010402b:	68 fb 78 10 80       	push   $0x801078fb
...
80104058:	8b 14 85 f0 75 10 80 	mov    -0x7fef8a10(,%eax,4),%edx
      state = "???";
...
801040d6:	eb 22                	jmp    801040fa <recursive+0x2a>
801040d8:	90                   	nop
...
801040e3:	8d 50 ff             	lea    -0x1(%eax),%edx
801040e6:	50                   	push   %eax
801040e7:	68 8d 75 10 80       	push   $0x8010758d
801040ec:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
801040f2:	e8 69 c5 ff ff       	call   80100660 <cprintf>
    return recursive();
801040f7:	83 c4 10             	add    $0x10,%esp
  acquire(&ptable.lock);
801040fa:	83 ec 0c             	sub    $0xc,%esp
801040fd:	68 c0 2e 11 80       	push   $0x80112ec0
80104102:	e8 d9 02 00 00       	call   801043e0 <acquire>
  if (counter > 0) {
80104107:	a1 04 a0 10 80       	mov    0x8010a004,%eax
8010410c:	83 c4 10             	add    $0x10,%esp
8010410f:	85 c0                	test   %eax,%eax
80104111:	7f cd                	jg     801040e0 <recursive+0x10>
  }
  else { 
    release(&ptable.lock);
80104113:	83 ec 0c             	sub    $0xc,%esp
80104116:	68 c0 2e 11 80       	push   $0x80112ec0
8010411b:	e8 a0 03 00 00       	call   801044c0 <release>
    return 1;
  }
}
80104120:	b8 01 00 00 00       	mov    $0x1,%eax
80104125:	c9                   	leave  
80104126:	c3                   	ret    
...
80104134:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80104137:	e8 d4 01 00 00       	call   80104310 <pushcli>
  c = mycpu();
8010413c:	e8 ff f5 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80104141:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104147:	e8 04 02 00 00       	call   80104350 <popcli>
  int out = 0;
  ptable.lock.pid = myproc()->pid;
8010414c:	8b 43 10             	mov    0x10(%ebx),%eax
8010414f:	a3 f4 2e 11 80       	mov    %eax,0x80112ef4
  out = recursive();
80104154:	e8 77 ff ff ff       	call   801040d0 <recursive>
  ptable.lock.pid = -1;
80104159:	c7 05 f4 2e 11 80 ff 	movl   $0xffffffff,0x80112ef4
80104160:	ff ff ff 
  return out;
}
80104163:	83 c4 04             	add    $0x4,%esp
80104166:	5b                   	pop    %ebx
80104167:	5d                   	pop    %ebp
80104168:	c3                   	ret    
...
8010417a:	68 08 76 10 80       	push   $0x80107608
...
80104191:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104194:	c7 43 40 00 00 00 00 	movl   $0x0,0x40(%ebx)
  lk->name = name;
8010419b:	89 43 3c             	mov    %eax,0x3c(%ebx)
}
...
801041f1:	89 43 40             	mov    %eax,0x40(%ebx)
  release(&lk->lk);
...
801041fc:	5d                   	pop    %ebp
  release(&lk->lk);
801041fd:	e9 be 02 00 00       	jmp    801044c0 <release>
...
80104224:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
8010422a:	c7 43 40 00 00 00 00 	movl   $0x0,0x40(%ebx)
  wakeup(lk);
...
80104244:	5d                   	pop    %ebp
  release(&lk->lk);
80104245:	e9 76 02 00 00       	jmp    801044c0 <release>
...
80104270:	8b 5b 40             	mov    0x40(%ebx),%ebx
...
80104287:	e8 34 02 00 00       	call   801044c0 <release>
  return r;
}
...
80104395:	68 13 76 10 80       	push   $0x80107613
8010439a:	e8 f1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
8010439f:	83 ec 0c             	sub    $0xc,%esp
801043a2:	68 2a 76 10 80       	push   $0x8010762a
...
801043e5:	e8 26 ff ff ff       	call   80104310 <pushcli>
  if (holding(lk)) {
801043ea:	8b 75 08             	mov    0x8(%ebp),%esi
...
801043fd:	ba 01 00 00 00       	mov    $0x1,%edx
80104402:	74 0f                	je     80104413 <acquire+0x33>
80104404:	e9 87 00 00 00       	jmp    80104490 <acquire+0xb0>
80104409:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104410:	8b 75 08             	mov    0x8(%ebp),%esi
  asm volatile("lock; xchgl %0, %1" :
80104413:	89 d0                	mov    %edx,%eax
80104415:	f0 87 06             	lock xchg %eax,(%esi)
...
8010441c:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104421:	8b 75 08             	mov    0x8(%ebp),%esi
80104424:	e8 17 f3 ff ff       	call   80103740 <mycpu>
  for(i = 0; i < 10; i++){
80104429:	31 d2                	xor    %edx,%edx
  getcallerpcs(&lk, lk->pcs);
8010442b:	8d 4e 0c             	lea    0xc(%esi),%ecx
  lk->cpu = mycpu();
8010442e:	89 46 08             	mov    %eax,0x8(%esi)
  ebp = (uint*)v - 2;
80104431:	89 e8                	mov    %ebp,%eax
80104433:	90                   	nop
80104434:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104438:	8d b0 00 00 00 80    	lea    -0x80000000(%eax),%esi
8010443e:	81 fe fe ff ff 7f    	cmp    $0x7ffffffe,%esi
80104444:	77 22                	ja     80104468 <acquire+0x88>
    pcs[i] = ebp[1];     // saved %eip
80104446:	8b 70 04             	mov    0x4(%eax),%esi
80104449:	89 34 91             	mov    %esi,(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
...
80104459:	74 27                	je     80104482 <acquire+0xa2>
}
8010445b:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010445e:	5b                   	pop    %ebx
8010445f:	5e                   	pop    %esi
80104460:	5d                   	pop    %ebp
80104461:	c3                   	ret    
...
80104476:	83 c0 04             	add    $0x4,%eax
  for(; i < 10; i++)
80104479:	39 c8                	cmp    %ecx,%eax
8010447b:	75 f3                	jne    80104470 <acquire+0x90>
  if (flag == 1)
8010447d:	83 fb 01             	cmp    $0x1,%ebx
80104480:	75 d9                	jne    8010445b <acquire+0x7b>
    popcli();
80104482:	e8 c9 fe ff ff       	call   80104350 <popcli>
}
...
80104490:	e8 4b f3 ff ff       	call   801037e0 <myproc>
80104495:	8b 5e 34             	mov    0x34(%esi),%ebx
80104498:	39 58 10             	cmp    %ebx,0x10(%eax)
8010449b:	75 0a                	jne    801044a7 <acquire+0xc7>
      flag = 1;
8010449d:	bb 01 00 00 00       	mov    $0x1,%ebx
801044a2:	e9 75 ff ff ff       	jmp    8010441c <acquire+0x3c>
      panic("acquire");
801044a7:	83 ec 0c             	sub    $0xc,%esp
801044aa:	68 31 76 10 80       	push   $0x80107631
801044af:	e8 dc be ff ff       	call   80100390 <panic>
...
801044cb:	e8 e0 fe ff ff       	call   801043b0 <holding>
...
801044f3:	c9                   	leave  
  popcli();
801044f4:	e9 57 fe ff ff       	jmp    80104350 <popcli>
    panic("release");
801044f9:	83 ec 0c             	sub    $0xc,%esp
801044fc:	68 39 76 10 80       	push   $0x80107639
...
80104940:	68 41 76 10 80       	push   $0x80107641
...
801049c9:	66 83 7f 54 02       	cmpw   $0x2,0x54(%edi)
...
80104a09:	66 89 47 56          	mov    %ax,0x56(%edi)
80104a0d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104a11:	66 89 47 58          	mov    %ax,0x58(%edi)
80104a15:	b8 01 00 00 00       	mov    $0x1,%eax
80104a1a:	66 89 47 5a          	mov    %ax,0x5a(%edi)
...
80104a80:	66 83 43 5a 01       	addw   $0x1,0x5a(%ebx)
...
80104a94:	68 d8 76 10 80       	push   $0x801076d8
...
80104aac:	68 d7 76 10 80       	push   $0x801076d7
...
80104ac5:	68 cb 76 10 80       	push   $0x801076cb
...
80104ada:	68 da 76 10 80       	push   $0x801076da
80104adf:	e8 ac b8 ff ff       	call   80100390 <panic>
80104ae4:	83 ec 0c             	sub    $0xc,%esp
80104ae7:	68 bc 76 10 80       	push   $0x801076bc
...
80104da1:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
80104da6:	0f 84 bb 00 00 00    	je     80104e67 <sys_link+0x127>
80104dac:	66 83 43 5a 01       	addw   $0x1,0x5a(%ebx)
...
80104e3d:	66 83 6b 5a 01       	subw   $0x1,0x5a(%ebx)
...
80104ed9:	58                   	pop    %eax
80104eda:	5a                   	pop    %edx
80104edb:	68 d8 76 10 80       	push   $0x801076d8
...
80104ef4:	68 d7 76 10 80       	push   $0x801076d7
...
80104f31:	66 83 7b 5a 00       	cmpw   $0x0,0x5a(%ebx)
80104f36:	0f 8e 10 01 00 00    	jle    8010504c <sys_unlink+0x1bc>
80104f3c:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80104f6e:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80104f82:	66 83 6b 5a 01       	subw   $0x1,0x5a(%ebx)
...
80104fb0:	83 7b 5c 20          	cmpl   $0x20,0x5c(%ebx)
...
80104fc3:	3b 7b 5c             	cmp    0x5c(%ebx),%edi
...
80105010:	66 83 6e 5a 01       	subw   $0x1,0x5a(%esi)
...
801050db:	66 83 7e 54 01       	cmpw   $0x1,0x54(%esi)
...
80105309:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80105630:	68 00 4e 11 80       	push   $0x80114e00
80105635:	e8 a6 ed ff ff       	call   801043e0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010563a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010563d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105640:	8b 1d 40 56 11 80    	mov    0x80115640,%ebx
  while(ticks - ticks0 < n){
...
80105653:	68 00 4e 11 80       	push   $0x80114e00
80105658:	68 40 56 11 80       	push   $0x80115640
8010565d:	e8 1e e7 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
80105662:	a1 40 56 11 80       	mov    0x80115640,%eax
...
80105680:	68 00 4e 11 80       	push   $0x80114e00
...
801056a3:	68 00 4e 11 80       	push   $0x80114e00
...
801056c4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801056c7:	68 00 4e 11 80       	push   $0x80114e00
801056cc:	e8 0f ed ff ff       	call   801043e0 <acquire>
  xticks = ticks;
801056d1:	8b 1d 40 56 11 80    	mov    0x80115640,%ebx
  release(&tickslock);
801056d7:	c7 04 24 00 4e 11 80 	movl   $0x80114e00,(%esp)
...
801056f3:	5d                   	pop    %ebp
  return recursiveCall();
801056f4:	e9 37 ea ff ff       	jmp    80104130 <recursiveCall>

801056f9 <alltraps>:
801056f9:	1e                   	push   %ds
801056fa:	06                   	push   %es
801056fb:	0f a0                	push   %fs
801056fd:	0f a8                	push   %gs
801056ff:	60                   	pusha  
80105700:	66 b8 10 00          	mov    $0x10,%ax
80105704:	8e d8                	mov    %eax,%ds
80105706:	8e c0                	mov    %eax,%es
80105708:	54                   	push   %esp
80105709:	e8 c2 00 00 00       	call   801057d0 <trap>
8010570e:	83 c4 04             	add    $0x4,%esp

80105711 <trapret>:
80105711:	61                   	popa   
80105712:	0f a9                	pop    %gs
80105714:	0f a1                	pop    %fs
80105716:	07                   	pop    %es
80105717:	1f                   	pop    %ds
80105718:	83 c4 08             	add    $0x8,%esp
8010571b:	cf                   	iret   
...
80105737:	c7 04 c5 42 4e 11 80 	movl   $0x8e000008,-0x7feeb1be(,%eax,8)
8010573e:	08 00 00 8e 
80105742:	66 89 14 c5 40 4e 11 	mov    %dx,-0x7feeb1c0(,%eax,8)
80105749:	80 
8010574a:	c1 ea 10             	shr    $0x10,%edx
8010574d:	66 89 14 c5 46 4e 11 	mov    %dx,-0x7feeb1ba(,%eax,8)
80105754:	80 
  for(i = 0; i < 256; i++)
...
8010575f:	a1 0c a1 10 80       	mov    0x8010a10c,%eax

  initlock(&tickslock, "time");
80105764:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105767:	c7 05 42 50 11 80 08 	movl   $0xef000008,0x80115042
8010576e:	00 00 ef 
  initlock(&tickslock, "time");
80105771:	68 1d 77 10 80       	push   $0x8010771d
80105776:	68 00 4e 11 80       	push   $0x80114e00
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010577b:	66 a3 40 50 11 80    	mov    %ax,0x80115040
80105781:	c1 e8 10             	shr    $0x10,%eax
80105784:	66 a3 46 50 11 80    	mov    %ax,0x80115046
  initlock(&tickslock, "time");
...
801057ab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801057af:	b8 40 4e 11 80       	mov    $0x80114e40,%eax
...
80105855:	68 80 77 10 80       	push   $0x80107780
...
801058ed:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058f0:	e8 0b f0 ff ff       	call   80104900 <syscall>
    if(myproc()->killed)
...
80105997:	68 28 77 10 80       	push   $0x80107728
...
801059f3:	68 00 4e 11 80       	push   $0x80114e00
801059f8:	e8 e3 e9 ff ff       	call   801043e0 <acquire>
      wakeup(&ticks);
801059fd:	c7 04 24 40 56 11 80 	movl   $0x80115640,(%esp)
      ticks++;
80105a04:	83 05 40 56 11 80 01 	addl   $0x1,0x80115640
      wakeup(&ticks);
80105a0b:	e8 20 e5 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105a10:	c7 04 24 00 4e 11 80 	movl   $0x80114e00,(%esp)
...
80105a35:	68 4c 77 10 80       	push   $0x8010774c
80105a3a:	e8 21 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a3f:	83 c4 14             	add    $0x14,%esp
80105a42:	68 22 77 10 80       	push   $0x80107722
...
80105b27:	74 5a                	je     80105b83 <uartinit+0xb3>
  uart = 1;
80105b29:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105b30:	00 00 00 
...
80105b3c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b3f:	bb 44 78 10 80       	mov    $0x80107844,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b68:	74 19                	je     80105b83 <uartinit+0xb3>
  if(!uart)
80105b6a:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
...
80105b90 <uartputc>:
  if(!uart)
80105b90:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
{
...
80105bd9:	e9 1b fb ff ff       	jmp    801056f9 <alltraps>

80105bde <vector1>:
80105bde:	6a 00                	push   $0x0
80105be0:	6a 01                	push   $0x1
80105be2:	e9 12 fb ff ff       	jmp    801056f9 <alltraps>

80105be7 <vector2>:
80105be7:	6a 00                	push   $0x0
80105be9:	6a 02                	push   $0x2
80105beb:	e9 09 fb ff ff       	jmp    801056f9 <alltraps>

80105bf0 <vector3>:
80105bf0:	6a 00                	push   $0x0
80105bf2:	6a 03                	push   $0x3
80105bf4:	e9 00 fb ff ff       	jmp    801056f9 <alltraps>

80105bf9 <vector4>:
80105bf9:	6a 00                	push   $0x0
80105bfb:	6a 04                	push   $0x4
80105bfd:	e9 f7 fa ff ff       	jmp    801056f9 <alltraps>

80105c02 <vector5>:
80105c02:	6a 00                	push   $0x0
80105c04:	6a 05                	push   $0x5
80105c06:	e9 ee fa ff ff       	jmp    801056f9 <alltraps>

80105c0b <vector6>:
80105c0b:	6a 00                	push   $0x0
80105c0d:	6a 06                	push   $0x6
80105c0f:	e9 e5 fa ff ff       	jmp    801056f9 <alltraps>

80105c14 <vector7>:
80105c14:	6a 00                	push   $0x0
80105c16:	6a 07                	push   $0x7
80105c18:	e9 dc fa ff ff       	jmp    801056f9 <alltraps>

80105c1d <vector8>:
80105c1d:	6a 08                	push   $0x8
80105c1f:	e9 d5 fa ff ff       	jmp    801056f9 <alltraps>

80105c24 <vector9>:
80105c24:	6a 00                	push   $0x0
80105c26:	6a 09                	push   $0x9
80105c28:	e9 cc fa ff ff       	jmp    801056f9 <alltraps>

80105c2d <vector10>:
80105c2d:	6a 0a                	push   $0xa
80105c2f:	e9 c5 fa ff ff       	jmp    801056f9 <alltraps>

80105c34 <vector11>:
80105c34:	6a 0b                	push   $0xb
80105c36:	e9 be fa ff ff       	jmp    801056f9 <alltraps>

80105c3b <vector12>:
80105c3b:	6a 0c                	push   $0xc
80105c3d:	e9 b7 fa ff ff       	jmp    801056f9 <alltraps>

80105c42 <vector13>:
80105c42:	6a 0d                	push   $0xd
80105c44:	e9 b0 fa ff ff       	jmp    801056f9 <alltraps>

80105c49 <vector14>:
80105c49:	6a 0e                	push   $0xe
80105c4b:	e9 a9 fa ff ff       	jmp    801056f9 <alltraps>

80105c50 <vector15>:
80105c50:	6a 00                	push   $0x0
80105c52:	6a 0f                	push   $0xf
80105c54:	e9 a0 fa ff ff       	jmp    801056f9 <alltraps>

80105c59 <vector16>:
80105c59:	6a 00                	push   $0x0
80105c5b:	6a 10                	push   $0x10
80105c5d:	e9 97 fa ff ff       	jmp    801056f9 <alltraps>

80105c62 <vector17>:
80105c62:	6a 11                	push   $0x11
80105c64:	e9 90 fa ff ff       	jmp    801056f9 <alltraps>

80105c69 <vector18>:
80105c69:	6a 00                	push   $0x0
80105c6b:	6a 12                	push   $0x12
80105c6d:	e9 87 fa ff ff       	jmp    801056f9 <alltraps>

80105c72 <vector19>:
80105c72:	6a 00                	push   $0x0
80105c74:	6a 13                	push   $0x13
80105c76:	e9 7e fa ff ff       	jmp    801056f9 <alltraps>

80105c7b <vector20>:
80105c7b:	6a 00                	push   $0x0
80105c7d:	6a 14                	push   $0x14
80105c7f:	e9 75 fa ff ff       	jmp    801056f9 <alltraps>

80105c84 <vector21>:
80105c84:	6a 00                	push   $0x0
80105c86:	6a 15                	push   $0x15
80105c88:	e9 6c fa ff ff       	jmp    801056f9 <alltraps>

80105c8d <vector22>:
80105c8d:	6a 00                	push   $0x0
80105c8f:	6a 16                	push   $0x16
80105c91:	e9 63 fa ff ff       	jmp    801056f9 <alltraps>

80105c96 <vector23>:
80105c96:	6a 00                	push   $0x0
80105c98:	6a 17                	push   $0x17
80105c9a:	e9 5a fa ff ff       	jmp    801056f9 <alltraps>

80105c9f <vector24>:
80105c9f:	6a 00                	push   $0x0
80105ca1:	6a 18                	push   $0x18
80105ca3:	e9 51 fa ff ff       	jmp    801056f9 <alltraps>

80105ca8 <vector25>:
80105ca8:	6a 00                	push   $0x0
80105caa:	6a 19                	push   $0x19
80105cac:	e9 48 fa ff ff       	jmp    801056f9 <alltraps>

80105cb1 <vector26>:
80105cb1:	6a 00                	push   $0x0
80105cb3:	6a 1a                	push   $0x1a
80105cb5:	e9 3f fa ff ff       	jmp    801056f9 <alltraps>

80105cba <vector27>:
80105cba:	6a 00                	push   $0x0
80105cbc:	6a 1b                	push   $0x1b
80105cbe:	e9 36 fa ff ff       	jmp    801056f9 <alltraps>

80105cc3 <vector28>:
80105cc3:	6a 00                	push   $0x0
80105cc5:	6a 1c                	push   $0x1c
80105cc7:	e9 2d fa ff ff       	jmp    801056f9 <alltraps>

80105ccc <vector29>:
80105ccc:	6a 00                	push   $0x0
80105cce:	6a 1d                	push   $0x1d
80105cd0:	e9 24 fa ff ff       	jmp    801056f9 <alltraps>

80105cd5 <vector30>:
80105cd5:	6a 00                	push   $0x0
80105cd7:	6a 1e                	push   $0x1e
80105cd9:	e9 1b fa ff ff       	jmp    801056f9 <alltraps>

80105cde <vector31>:
80105cde:	6a 00                	push   $0x0
80105ce0:	6a 1f                	push   $0x1f
80105ce2:	e9 12 fa ff ff       	jmp    801056f9 <alltraps>

80105ce7 <vector32>:
80105ce7:	6a 00                	push   $0x0
80105ce9:	6a 20                	push   $0x20
80105ceb:	e9 09 fa ff ff       	jmp    801056f9 <alltraps>

80105cf0 <vector33>:
80105cf0:	6a 00                	push   $0x0
80105cf2:	6a 21                	push   $0x21
80105cf4:	e9 00 fa ff ff       	jmp    801056f9 <alltraps>

80105cf9 <vector34>:
80105cf9:	6a 00                	push   $0x0
80105cfb:	6a 22                	push   $0x22
80105cfd:	e9 f7 f9 ff ff       	jmp    801056f9 <alltraps>

80105d02 <vector35>:
80105d02:	6a 00                	push   $0x0
80105d04:	6a 23                	push   $0x23
80105d06:	e9 ee f9 ff ff       	jmp    801056f9 <alltraps>

80105d0b <vector36>:
80105d0b:	6a 00                	push   $0x0
80105d0d:	6a 24                	push   $0x24
80105d0f:	e9 e5 f9 ff ff       	jmp    801056f9 <alltraps>

80105d14 <vector37>:
80105d14:	6a 00                	push   $0x0
80105d16:	6a 25                	push   $0x25
80105d18:	e9 dc f9 ff ff       	jmp    801056f9 <alltraps>

80105d1d <vector38>:
80105d1d:	6a 00                	push   $0x0
80105d1f:	6a 26                	push   $0x26
80105d21:	e9 d3 f9 ff ff       	jmp    801056f9 <alltraps>

80105d26 <vector39>:
80105d26:	6a 00                	push   $0x0
80105d28:	6a 27                	push   $0x27
80105d2a:	e9 ca f9 ff ff       	jmp    801056f9 <alltraps>

80105d2f <vector40>:
80105d2f:	6a 00                	push   $0x0
80105d31:	6a 28                	push   $0x28
80105d33:	e9 c1 f9 ff ff       	jmp    801056f9 <alltraps>

80105d38 <vector41>:
80105d38:	6a 00                	push   $0x0
80105d3a:	6a 29                	push   $0x29
80105d3c:	e9 b8 f9 ff ff       	jmp    801056f9 <alltraps>

80105d41 <vector42>:
80105d41:	6a 00                	push   $0x0
80105d43:	6a 2a                	push   $0x2a
80105d45:	e9 af f9 ff ff       	jmp    801056f9 <alltraps>

80105d4a <vector43>:
80105d4a:	6a 00                	push   $0x0
80105d4c:	6a 2b                	push   $0x2b
80105d4e:	e9 a6 f9 ff ff       	jmp    801056f9 <alltraps>

80105d53 <vector44>:
80105d53:	6a 00                	push   $0x0
80105d55:	6a 2c                	push   $0x2c
80105d57:	e9 9d f9 ff ff       	jmp    801056f9 <alltraps>

80105d5c <vector45>:
80105d5c:	6a 00                	push   $0x0
80105d5e:	6a 2d                	push   $0x2d
80105d60:	e9 94 f9 ff ff       	jmp    801056f9 <alltraps>

80105d65 <vector46>:
80105d65:	6a 00                	push   $0x0
80105d67:	6a 2e                	push   $0x2e
80105d69:	e9 8b f9 ff ff       	jmp    801056f9 <alltraps>

80105d6e <vector47>:
80105d6e:	6a 00                	push   $0x0
80105d70:	6a 2f                	push   $0x2f
80105d72:	e9 82 f9 ff ff       	jmp    801056f9 <alltraps>

80105d77 <vector48>:
80105d77:	6a 00                	push   $0x0
80105d79:	6a 30                	push   $0x30
80105d7b:	e9 79 f9 ff ff       	jmp    801056f9 <alltraps>

80105d80 <vector49>:
80105d80:	6a 00                	push   $0x0
80105d82:	6a 31                	push   $0x31
80105d84:	e9 70 f9 ff ff       	jmp    801056f9 <alltraps>

80105d89 <vector50>:
80105d89:	6a 00                	push   $0x0
80105d8b:	6a 32                	push   $0x32
80105d8d:	e9 67 f9 ff ff       	jmp    801056f9 <alltraps>

80105d92 <vector51>:
80105d92:	6a 00                	push   $0x0
80105d94:	6a 33                	push   $0x33
80105d96:	e9 5e f9 ff ff       	jmp    801056f9 <alltraps>

80105d9b <vector52>:
80105d9b:	6a 00                	push   $0x0
80105d9d:	6a 34                	push   $0x34
80105d9f:	e9 55 f9 ff ff       	jmp    801056f9 <alltraps>

80105da4 <vector53>:
80105da4:	6a 00                	push   $0x0
80105da6:	6a 35                	push   $0x35
80105da8:	e9 4c f9 ff ff       	jmp    801056f9 <alltraps>

80105dad <vector54>:
80105dad:	6a 00                	push   $0x0
80105daf:	6a 36                	push   $0x36
80105db1:	e9 43 f9 ff ff       	jmp    801056f9 <alltraps>

80105db6 <vector55>:
80105db6:	6a 00                	push   $0x0
80105db8:	6a 37                	push   $0x37
80105dba:	e9 3a f9 ff ff       	jmp    801056f9 <alltraps>

80105dbf <vector56>:
80105dbf:	6a 00                	push   $0x0
80105dc1:	6a 38                	push   $0x38
80105dc3:	e9 31 f9 ff ff       	jmp    801056f9 <alltraps>

80105dc8 <vector57>:
80105dc8:	6a 00                	push   $0x0
80105dca:	6a 39                	push   $0x39
80105dcc:	e9 28 f9 ff ff       	jmp    801056f9 <alltraps>

80105dd1 <vector58>:
80105dd1:	6a 00                	push   $0x0
80105dd3:	6a 3a                	push   $0x3a
80105dd5:	e9 1f f9 ff ff       	jmp    801056f9 <alltraps>

80105dda <vector59>:
80105dda:	6a 00                	push   $0x0
80105ddc:	6a 3b                	push   $0x3b
80105dde:	e9 16 f9 ff ff       	jmp    801056f9 <alltraps>

80105de3 <vector60>:
80105de3:	6a 00                	push   $0x0
80105de5:	6a 3c                	push   $0x3c
80105de7:	e9 0d f9 ff ff       	jmp    801056f9 <alltraps>

80105dec <vector61>:
80105dec:	6a 00                	push   $0x0
80105dee:	6a 3d                	push   $0x3d
80105df0:	e9 04 f9 ff ff       	jmp    801056f9 <alltraps>

80105df5 <vector62>:
80105df5:	6a 00                	push   $0x0
80105df7:	6a 3e                	push   $0x3e
80105df9:	e9 fb f8 ff ff       	jmp    801056f9 <alltraps>

80105dfe <vector63>:
80105dfe:	6a 00                	push   $0x0
80105e00:	6a 3f                	push   $0x3f
80105e02:	e9 f2 f8 ff ff       	jmp    801056f9 <alltraps>

80105e07 <vector64>:
80105e07:	6a 00                	push   $0x0
80105e09:	6a 40                	push   $0x40
80105e0b:	e9 e9 f8 ff ff       	jmp    801056f9 <alltraps>

80105e10 <vector65>:
80105e10:	6a 00                	push   $0x0
80105e12:	6a 41                	push   $0x41
80105e14:	e9 e0 f8 ff ff       	jmp    801056f9 <alltraps>

80105e19 <vector66>:
80105e19:	6a 00                	push   $0x0
80105e1b:	6a 42                	push   $0x42
80105e1d:	e9 d7 f8 ff ff       	jmp    801056f9 <alltraps>

80105e22 <vector67>:
80105e22:	6a 00                	push   $0x0
80105e24:	6a 43                	push   $0x43
80105e26:	e9 ce f8 ff ff       	jmp    801056f9 <alltraps>

80105e2b <vector68>:
80105e2b:	6a 00                	push   $0x0
80105e2d:	6a 44                	push   $0x44
80105e2f:	e9 c5 f8 ff ff       	jmp    801056f9 <alltraps>

80105e34 <vector69>:
80105e34:	6a 00                	push   $0x0
80105e36:	6a 45                	push   $0x45
80105e38:	e9 bc f8 ff ff       	jmp    801056f9 <alltraps>

80105e3d <vector70>:
80105e3d:	6a 00                	push   $0x0
80105e3f:	6a 46                	push   $0x46
80105e41:	e9 b3 f8 ff ff       	jmp    801056f9 <alltraps>

80105e46 <vector71>:
80105e46:	6a 00                	push   $0x0
80105e48:	6a 47                	push   $0x47
80105e4a:	e9 aa f8 ff ff       	jmp    801056f9 <alltraps>

80105e4f <vector72>:
80105e4f:	6a 00                	push   $0x0
80105e51:	6a 48                	push   $0x48
80105e53:	e9 a1 f8 ff ff       	jmp    801056f9 <alltraps>

80105e58 <vector73>:
80105e58:	6a 00                	push   $0x0
80105e5a:	6a 49                	push   $0x49
80105e5c:	e9 98 f8 ff ff       	jmp    801056f9 <alltraps>

80105e61 <vector74>:
80105e61:	6a 00                	push   $0x0
80105e63:	6a 4a                	push   $0x4a
80105e65:	e9 8f f8 ff ff       	jmp    801056f9 <alltraps>

80105e6a <vector75>:
80105e6a:	6a 00                	push   $0x0
80105e6c:	6a 4b                	push   $0x4b
80105e6e:	e9 86 f8 ff ff       	jmp    801056f9 <alltraps>

80105e73 <vector76>:
80105e73:	6a 00                	push   $0x0
80105e75:	6a 4c                	push   $0x4c
80105e77:	e9 7d f8 ff ff       	jmp    801056f9 <alltraps>

80105e7c <vector77>:
80105e7c:	6a 00                	push   $0x0
80105e7e:	6a 4d                	push   $0x4d
80105e80:	e9 74 f8 ff ff       	jmp    801056f9 <alltraps>

80105e85 <vector78>:
80105e85:	6a 00                	push   $0x0
80105e87:	6a 4e                	push   $0x4e
80105e89:	e9 6b f8 ff ff       	jmp    801056f9 <alltraps>

80105e8e <vector79>:
80105e8e:	6a 00                	push   $0x0
80105e90:	6a 4f                	push   $0x4f
80105e92:	e9 62 f8 ff ff       	jmp    801056f9 <alltraps>

80105e97 <vector80>:
80105e97:	6a 00                	push   $0x0
80105e99:	6a 50                	push   $0x50
80105e9b:	e9 59 f8 ff ff       	jmp    801056f9 <alltraps>

80105ea0 <vector81>:
80105ea0:	6a 00                	push   $0x0
80105ea2:	6a 51                	push   $0x51
80105ea4:	e9 50 f8 ff ff       	jmp    801056f9 <alltraps>

80105ea9 <vector82>:
80105ea9:	6a 00                	push   $0x0
80105eab:	6a 52                	push   $0x52
80105ead:	e9 47 f8 ff ff       	jmp    801056f9 <alltraps>

80105eb2 <vector83>:
80105eb2:	6a 00                	push   $0x0
80105eb4:	6a 53                	push   $0x53
80105eb6:	e9 3e f8 ff ff       	jmp    801056f9 <alltraps>

80105ebb <vector84>:
80105ebb:	6a 00                	push   $0x0
80105ebd:	6a 54                	push   $0x54
80105ebf:	e9 35 f8 ff ff       	jmp    801056f9 <alltraps>

80105ec4 <vector85>:
80105ec4:	6a 00                	push   $0x0
80105ec6:	6a 55                	push   $0x55
80105ec8:	e9 2c f8 ff ff       	jmp    801056f9 <alltraps>

80105ecd <vector86>:
80105ecd:	6a 00                	push   $0x0
80105ecf:	6a 56                	push   $0x56
80105ed1:	e9 23 f8 ff ff       	jmp    801056f9 <alltraps>

80105ed6 <vector87>:
80105ed6:	6a 00                	push   $0x0
80105ed8:	6a 57                	push   $0x57
80105eda:	e9 1a f8 ff ff       	jmp    801056f9 <alltraps>

80105edf <vector88>:
80105edf:	6a 00                	push   $0x0
80105ee1:	6a 58                	push   $0x58
80105ee3:	e9 11 f8 ff ff       	jmp    801056f9 <alltraps>

80105ee8 <vector89>:
80105ee8:	6a 00                	push   $0x0
80105eea:	6a 59                	push   $0x59
80105eec:	e9 08 f8 ff ff       	jmp    801056f9 <alltraps>

80105ef1 <vector90>:
80105ef1:	6a 00                	push   $0x0
80105ef3:	6a 5a                	push   $0x5a
80105ef5:	e9 ff f7 ff ff       	jmp    801056f9 <alltraps>

80105efa <vector91>:
80105efa:	6a 00                	push   $0x0
80105efc:	6a 5b                	push   $0x5b
80105efe:	e9 f6 f7 ff ff       	jmp    801056f9 <alltraps>

80105f03 <vector92>:
80105f03:	6a 00                	push   $0x0
80105f05:	6a 5c                	push   $0x5c
80105f07:	e9 ed f7 ff ff       	jmp    801056f9 <alltraps>

80105f0c <vector93>:
80105f0c:	6a 00                	push   $0x0
80105f0e:	6a 5d                	push   $0x5d
80105f10:	e9 e4 f7 ff ff       	jmp    801056f9 <alltraps>

80105f15 <vector94>:
80105f15:	6a 00                	push   $0x0
80105f17:	6a 5e                	push   $0x5e
80105f19:	e9 db f7 ff ff       	jmp    801056f9 <alltraps>

80105f1e <vector95>:
80105f1e:	6a 00                	push   $0x0
80105f20:	6a 5f                	push   $0x5f
80105f22:	e9 d2 f7 ff ff       	jmp    801056f9 <alltraps>

80105f27 <vector96>:
80105f27:	6a 00                	push   $0x0
80105f29:	6a 60                	push   $0x60
80105f2b:	e9 c9 f7 ff ff       	jmp    801056f9 <alltraps>

80105f30 <vector97>:
80105f30:	6a 00                	push   $0x0
80105f32:	6a 61                	push   $0x61
80105f34:	e9 c0 f7 ff ff       	jmp    801056f9 <alltraps>

80105f39 <vector98>:
80105f39:	6a 00                	push   $0x0
80105f3b:	6a 62                	push   $0x62
80105f3d:	e9 b7 f7 ff ff       	jmp    801056f9 <alltraps>

80105f42 <vector99>:
80105f42:	6a 00                	push   $0x0
80105f44:	6a 63                	push   $0x63
80105f46:	e9 ae f7 ff ff       	jmp    801056f9 <alltraps>

80105f4b <vector100>:
80105f4b:	6a 00                	push   $0x0
80105f4d:	6a 64                	push   $0x64
80105f4f:	e9 a5 f7 ff ff       	jmp    801056f9 <alltraps>

80105f54 <vector101>:
80105f54:	6a 00                	push   $0x0
80105f56:	6a 65                	push   $0x65
80105f58:	e9 9c f7 ff ff       	jmp    801056f9 <alltraps>

80105f5d <vector102>:
80105f5d:	6a 00                	push   $0x0
80105f5f:	6a 66                	push   $0x66
80105f61:	e9 93 f7 ff ff       	jmp    801056f9 <alltraps>

80105f66 <vector103>:
80105f66:	6a 00                	push   $0x0
80105f68:	6a 67                	push   $0x67
80105f6a:	e9 8a f7 ff ff       	jmp    801056f9 <alltraps>

80105f6f <vector104>:
80105f6f:	6a 00                	push   $0x0
80105f71:	6a 68                	push   $0x68
80105f73:	e9 81 f7 ff ff       	jmp    801056f9 <alltraps>

80105f78 <vector105>:
80105f78:	6a 00                	push   $0x0
80105f7a:	6a 69                	push   $0x69
80105f7c:	e9 78 f7 ff ff       	jmp    801056f9 <alltraps>

80105f81 <vector106>:
80105f81:	6a 00                	push   $0x0
80105f83:	6a 6a                	push   $0x6a
80105f85:	e9 6f f7 ff ff       	jmp    801056f9 <alltraps>

80105f8a <vector107>:
80105f8a:	6a 00                	push   $0x0
80105f8c:	6a 6b                	push   $0x6b
80105f8e:	e9 66 f7 ff ff       	jmp    801056f9 <alltraps>

80105f93 <vector108>:
80105f93:	6a 00                	push   $0x0
80105f95:	6a 6c                	push   $0x6c
80105f97:	e9 5d f7 ff ff       	jmp    801056f9 <alltraps>

80105f9c <vector109>:
80105f9c:	6a 00                	push   $0x0
80105f9e:	6a 6d                	push   $0x6d
80105fa0:	e9 54 f7 ff ff       	jmp    801056f9 <alltraps>

80105fa5 <vector110>:
80105fa5:	6a 00                	push   $0x0
80105fa7:	6a 6e                	push   $0x6e
80105fa9:	e9 4b f7 ff ff       	jmp    801056f9 <alltraps>

80105fae <vector111>:
80105fae:	6a 00                	push   $0x0
80105fb0:	6a 6f                	push   $0x6f
80105fb2:	e9 42 f7 ff ff       	jmp    801056f9 <alltraps>

80105fb7 <vector112>:
80105fb7:	6a 00                	push   $0x0
80105fb9:	6a 70                	push   $0x70
80105fbb:	e9 39 f7 ff ff       	jmp    801056f9 <alltraps>

80105fc0 <vector113>:
80105fc0:	6a 00                	push   $0x0
80105fc2:	6a 71                	push   $0x71
80105fc4:	e9 30 f7 ff ff       	jmp    801056f9 <alltraps>

80105fc9 <vector114>:
80105fc9:	6a 00                	push   $0x0
80105fcb:	6a 72                	push   $0x72
80105fcd:	e9 27 f7 ff ff       	jmp    801056f9 <alltraps>

80105fd2 <vector115>:
80105fd2:	6a 00                	push   $0x0
80105fd4:	6a 73                	push   $0x73
80105fd6:	e9 1e f7 ff ff       	jmp    801056f9 <alltraps>

80105fdb <vector116>:
80105fdb:	6a 00                	push   $0x0
80105fdd:	6a 74                	push   $0x74
80105fdf:	e9 15 f7 ff ff       	jmp    801056f9 <alltraps>

80105fe4 <vector117>:
80105fe4:	6a 00                	push   $0x0
80105fe6:	6a 75                	push   $0x75
80105fe8:	e9 0c f7 ff ff       	jmp    801056f9 <alltraps>

80105fed <vector118>:
80105fed:	6a 00                	push   $0x0
80105fef:	6a 76                	push   $0x76
80105ff1:	e9 03 f7 ff ff       	jmp    801056f9 <alltraps>

80105ff6 <vector119>:
80105ff6:	6a 00                	push   $0x0
80105ff8:	6a 77                	push   $0x77
80105ffa:	e9 fa f6 ff ff       	jmp    801056f9 <alltraps>

80105fff <vector120>:
80105fff:	6a 00                	push   $0x0
80106001:	6a 78                	push   $0x78
80106003:	e9 f1 f6 ff ff       	jmp    801056f9 <alltraps>

80106008 <vector121>:
80106008:	6a 00                	push   $0x0
8010600a:	6a 79                	push   $0x79
8010600c:	e9 e8 f6 ff ff       	jmp    801056f9 <alltraps>

80106011 <vector122>:
80106011:	6a 00                	push   $0x0
80106013:	6a 7a                	push   $0x7a
80106015:	e9 df f6 ff ff       	jmp    801056f9 <alltraps>

8010601a <vector123>:
8010601a:	6a 00                	push   $0x0
8010601c:	6a 7b                	push   $0x7b
8010601e:	e9 d6 f6 ff ff       	jmp    801056f9 <alltraps>

80106023 <vector124>:
80106023:	6a 00                	push   $0x0
80106025:	6a 7c                	push   $0x7c
80106027:	e9 cd f6 ff ff       	jmp    801056f9 <alltraps>

8010602c <vector125>:
8010602c:	6a 00                	push   $0x0
8010602e:	6a 7d                	push   $0x7d
80106030:	e9 c4 f6 ff ff       	jmp    801056f9 <alltraps>

80106035 <vector126>:
80106035:	6a 00                	push   $0x0
80106037:	6a 7e                	push   $0x7e
80106039:	e9 bb f6 ff ff       	jmp    801056f9 <alltraps>

8010603e <vector127>:
8010603e:	6a 00                	push   $0x0
80106040:	6a 7f                	push   $0x7f
80106042:	e9 b2 f6 ff ff       	jmp    801056f9 <alltraps>

80106047 <vector128>:
80106047:	6a 00                	push   $0x0
80106049:	68 80 00 00 00       	push   $0x80
8010604e:	e9 a6 f6 ff ff       	jmp    801056f9 <alltraps>

80106053 <vector129>:
80106053:	6a 00                	push   $0x0
80106055:	68 81 00 00 00       	push   $0x81
8010605a:	e9 9a f6 ff ff       	jmp    801056f9 <alltraps>

8010605f <vector130>:
8010605f:	6a 00                	push   $0x0
80106061:	68 82 00 00 00       	push   $0x82
80106066:	e9 8e f6 ff ff       	jmp    801056f9 <alltraps>

8010606b <vector131>:
8010606b:	6a 00                	push   $0x0
8010606d:	68 83 00 00 00       	push   $0x83
80106072:	e9 82 f6 ff ff       	jmp    801056f9 <alltraps>

80106077 <vector132>:
80106077:	6a 00                	push   $0x0
80106079:	68 84 00 00 00       	push   $0x84
8010607e:	e9 76 f6 ff ff       	jmp    801056f9 <alltraps>

80106083 <vector133>:
80106083:	6a 00                	push   $0x0
80106085:	68 85 00 00 00       	push   $0x85
8010608a:	e9 6a f6 ff ff       	jmp    801056f9 <alltraps>

8010608f <vector134>:
8010608f:	6a 00                	push   $0x0
80106091:	68 86 00 00 00       	push   $0x86
80106096:	e9 5e f6 ff ff       	jmp    801056f9 <alltraps>

8010609b <vector135>:
8010609b:	6a 00                	push   $0x0
8010609d:	68 87 00 00 00       	push   $0x87
801060a2:	e9 52 f6 ff ff       	jmp    801056f9 <alltraps>

801060a7 <vector136>:
801060a7:	6a 00                	push   $0x0
801060a9:	68 88 00 00 00       	push   $0x88
801060ae:	e9 46 f6 ff ff       	jmp    801056f9 <alltraps>

801060b3 <vector137>:
801060b3:	6a 00                	push   $0x0
801060b5:	68 89 00 00 00       	push   $0x89
801060ba:	e9 3a f6 ff ff       	jmp    801056f9 <alltraps>

801060bf <vector138>:
801060bf:	6a 00                	push   $0x0
801060c1:	68 8a 00 00 00       	push   $0x8a
801060c6:	e9 2e f6 ff ff       	jmp    801056f9 <alltraps>

801060cb <vector139>:
801060cb:	6a 00                	push   $0x0
801060cd:	68 8b 00 00 00       	push   $0x8b
801060d2:	e9 22 f6 ff ff       	jmp    801056f9 <alltraps>

801060d7 <vector140>:
801060d7:	6a 00                	push   $0x0
801060d9:	68 8c 00 00 00       	push   $0x8c
801060de:	e9 16 f6 ff ff       	jmp    801056f9 <alltraps>

801060e3 <vector141>:
801060e3:	6a 00                	push   $0x0
801060e5:	68 8d 00 00 00       	push   $0x8d
801060ea:	e9 0a f6 ff ff       	jmp    801056f9 <alltraps>

801060ef <vector142>:
801060ef:	6a 00                	push   $0x0
801060f1:	68 8e 00 00 00       	push   $0x8e
801060f6:	e9 fe f5 ff ff       	jmp    801056f9 <alltraps>

801060fb <vector143>:
801060fb:	6a 00                	push   $0x0
801060fd:	68 8f 00 00 00       	push   $0x8f
80106102:	e9 f2 f5 ff ff       	jmp    801056f9 <alltraps>

80106107 <vector144>:
80106107:	6a 00                	push   $0x0
80106109:	68 90 00 00 00       	push   $0x90
8010610e:	e9 e6 f5 ff ff       	jmp    801056f9 <alltraps>

80106113 <vector145>:
80106113:	6a 00                	push   $0x0
80106115:	68 91 00 00 00       	push   $0x91
8010611a:	e9 da f5 ff ff       	jmp    801056f9 <alltraps>

8010611f <vector146>:
8010611f:	6a 00                	push   $0x0
80106121:	68 92 00 00 00       	push   $0x92
80106126:	e9 ce f5 ff ff       	jmp    801056f9 <alltraps>

8010612b <vector147>:
8010612b:	6a 00                	push   $0x0
8010612d:	68 93 00 00 00       	push   $0x93
80106132:	e9 c2 f5 ff ff       	jmp    801056f9 <alltraps>

80106137 <vector148>:
80106137:	6a 00                	push   $0x0
80106139:	68 94 00 00 00       	push   $0x94
8010613e:	e9 b6 f5 ff ff       	jmp    801056f9 <alltraps>

80106143 <vector149>:
80106143:	6a 00                	push   $0x0
80106145:	68 95 00 00 00       	push   $0x95
8010614a:	e9 aa f5 ff ff       	jmp    801056f9 <alltraps>

8010614f <vector150>:
8010614f:	6a 00                	push   $0x0
80106151:	68 96 00 00 00       	push   $0x96
80106156:	e9 9e f5 ff ff       	jmp    801056f9 <alltraps>

8010615b <vector151>:
8010615b:	6a 00                	push   $0x0
8010615d:	68 97 00 00 00       	push   $0x97
80106162:	e9 92 f5 ff ff       	jmp    801056f9 <alltraps>

80106167 <vector152>:
80106167:	6a 00                	push   $0x0
80106169:	68 98 00 00 00       	push   $0x98
8010616e:	e9 86 f5 ff ff       	jmp    801056f9 <alltraps>

80106173 <vector153>:
80106173:	6a 00                	push   $0x0
80106175:	68 99 00 00 00       	push   $0x99
8010617a:	e9 7a f5 ff ff       	jmp    801056f9 <alltraps>

8010617f <vector154>:
8010617f:	6a 00                	push   $0x0
80106181:	68 9a 00 00 00       	push   $0x9a
80106186:	e9 6e f5 ff ff       	jmp    801056f9 <alltraps>

8010618b <vector155>:
8010618b:	6a 00                	push   $0x0
8010618d:	68 9b 00 00 00       	push   $0x9b
80106192:	e9 62 f5 ff ff       	jmp    801056f9 <alltraps>

80106197 <vector156>:
80106197:	6a 00                	push   $0x0
80106199:	68 9c 00 00 00       	push   $0x9c
8010619e:	e9 56 f5 ff ff       	jmp    801056f9 <alltraps>

801061a3 <vector157>:
801061a3:	6a 00                	push   $0x0
801061a5:	68 9d 00 00 00       	push   $0x9d
801061aa:	e9 4a f5 ff ff       	jmp    801056f9 <alltraps>

801061af <vector158>:
801061af:	6a 00                	push   $0x0
801061b1:	68 9e 00 00 00       	push   $0x9e
801061b6:	e9 3e f5 ff ff       	jmp    801056f9 <alltraps>

801061bb <vector159>:
801061bb:	6a 00                	push   $0x0
801061bd:	68 9f 00 00 00       	push   $0x9f
801061c2:	e9 32 f5 ff ff       	jmp    801056f9 <alltraps>

801061c7 <vector160>:
801061c7:	6a 00                	push   $0x0
801061c9:	68 a0 00 00 00       	push   $0xa0
801061ce:	e9 26 f5 ff ff       	jmp    801056f9 <alltraps>

801061d3 <vector161>:
801061d3:	6a 00                	push   $0x0
801061d5:	68 a1 00 00 00       	push   $0xa1
801061da:	e9 1a f5 ff ff       	jmp    801056f9 <alltraps>

801061df <vector162>:
801061df:	6a 00                	push   $0x0
801061e1:	68 a2 00 00 00       	push   $0xa2
801061e6:	e9 0e f5 ff ff       	jmp    801056f9 <alltraps>

801061eb <vector163>:
801061eb:	6a 00                	push   $0x0
801061ed:	68 a3 00 00 00       	push   $0xa3
801061f2:	e9 02 f5 ff ff       	jmp    801056f9 <alltraps>

801061f7 <vector164>:
801061f7:	6a 00                	push   $0x0
801061f9:	68 a4 00 00 00       	push   $0xa4
801061fe:	e9 f6 f4 ff ff       	jmp    801056f9 <alltraps>

80106203 <vector165>:
80106203:	6a 00                	push   $0x0
80106205:	68 a5 00 00 00       	push   $0xa5
8010620a:	e9 ea f4 ff ff       	jmp    801056f9 <alltraps>

8010620f <vector166>:
8010620f:	6a 00                	push   $0x0
80106211:	68 a6 00 00 00       	push   $0xa6
80106216:	e9 de f4 ff ff       	jmp    801056f9 <alltraps>

8010621b <vector167>:
8010621b:	6a 00                	push   $0x0
8010621d:	68 a7 00 00 00       	push   $0xa7
80106222:	e9 d2 f4 ff ff       	jmp    801056f9 <alltraps>

80106227 <vector168>:
80106227:	6a 00                	push   $0x0
80106229:	68 a8 00 00 00       	push   $0xa8
8010622e:	e9 c6 f4 ff ff       	jmp    801056f9 <alltraps>

80106233 <vector169>:
80106233:	6a 00                	push   $0x0
80106235:	68 a9 00 00 00       	push   $0xa9
8010623a:	e9 ba f4 ff ff       	jmp    801056f9 <alltraps>

8010623f <vector170>:
8010623f:	6a 00                	push   $0x0
80106241:	68 aa 00 00 00       	push   $0xaa
80106246:	e9 ae f4 ff ff       	jmp    801056f9 <alltraps>

8010624b <vector171>:
8010624b:	6a 00                	push   $0x0
8010624d:	68 ab 00 00 00       	push   $0xab
80106252:	e9 a2 f4 ff ff       	jmp    801056f9 <alltraps>

80106257 <vector172>:
80106257:	6a 00                	push   $0x0
80106259:	68 ac 00 00 00       	push   $0xac
8010625e:	e9 96 f4 ff ff       	jmp    801056f9 <alltraps>

80106263 <vector173>:
80106263:	6a 00                	push   $0x0
80106265:	68 ad 00 00 00       	push   $0xad
8010626a:	e9 8a f4 ff ff       	jmp    801056f9 <alltraps>

8010626f <vector174>:
8010626f:	6a 00                	push   $0x0
80106271:	68 ae 00 00 00       	push   $0xae
80106276:	e9 7e f4 ff ff       	jmp    801056f9 <alltraps>

8010627b <vector175>:
8010627b:	6a 00                	push   $0x0
8010627d:	68 af 00 00 00       	push   $0xaf
80106282:	e9 72 f4 ff ff       	jmp    801056f9 <alltraps>

80106287 <vector176>:
80106287:	6a 00                	push   $0x0
80106289:	68 b0 00 00 00       	push   $0xb0
8010628e:	e9 66 f4 ff ff       	jmp    801056f9 <alltraps>

80106293 <vector177>:
80106293:	6a 00                	push   $0x0
80106295:	68 b1 00 00 00       	push   $0xb1
8010629a:	e9 5a f4 ff ff       	jmp    801056f9 <alltraps>

8010629f <vector178>:
8010629f:	6a 00                	push   $0x0
801062a1:	68 b2 00 00 00       	push   $0xb2
801062a6:	e9 4e f4 ff ff       	jmp    801056f9 <alltraps>

801062ab <vector179>:
801062ab:	6a 00                	push   $0x0
801062ad:	68 b3 00 00 00       	push   $0xb3
801062b2:	e9 42 f4 ff ff       	jmp    801056f9 <alltraps>

801062b7 <vector180>:
801062b7:	6a 00                	push   $0x0
801062b9:	68 b4 00 00 00       	push   $0xb4
801062be:	e9 36 f4 ff ff       	jmp    801056f9 <alltraps>

801062c3 <vector181>:
801062c3:	6a 00                	push   $0x0
801062c5:	68 b5 00 00 00       	push   $0xb5
801062ca:	e9 2a f4 ff ff       	jmp    801056f9 <alltraps>

801062cf <vector182>:
801062cf:	6a 00                	push   $0x0
801062d1:	68 b6 00 00 00       	push   $0xb6
801062d6:	e9 1e f4 ff ff       	jmp    801056f9 <alltraps>

801062db <vector183>:
801062db:	6a 00                	push   $0x0
801062dd:	68 b7 00 00 00       	push   $0xb7
801062e2:	e9 12 f4 ff ff       	jmp    801056f9 <alltraps>

801062e7 <vector184>:
801062e7:	6a 00                	push   $0x0
801062e9:	68 b8 00 00 00       	push   $0xb8
801062ee:	e9 06 f4 ff ff       	jmp    801056f9 <alltraps>

801062f3 <vector185>:
801062f3:	6a 00                	push   $0x0
801062f5:	68 b9 00 00 00       	push   $0xb9
801062fa:	e9 fa f3 ff ff       	jmp    801056f9 <alltraps>

801062ff <vector186>:
801062ff:	6a 00                	push   $0x0
80106301:	68 ba 00 00 00       	push   $0xba
80106306:	e9 ee f3 ff ff       	jmp    801056f9 <alltraps>

8010630b <vector187>:
8010630b:	6a 00                	push   $0x0
8010630d:	68 bb 00 00 00       	push   $0xbb
80106312:	e9 e2 f3 ff ff       	jmp    801056f9 <alltraps>

80106317 <vector188>:
80106317:	6a 00                	push   $0x0
80106319:	68 bc 00 00 00       	push   $0xbc
8010631e:	e9 d6 f3 ff ff       	jmp    801056f9 <alltraps>

80106323 <vector189>:
80106323:	6a 00                	push   $0x0
80106325:	68 bd 00 00 00       	push   $0xbd
8010632a:	e9 ca f3 ff ff       	jmp    801056f9 <alltraps>

8010632f <vector190>:
8010632f:	6a 00                	push   $0x0
80106331:	68 be 00 00 00       	push   $0xbe
80106336:	e9 be f3 ff ff       	jmp    801056f9 <alltraps>

8010633b <vector191>:
8010633b:	6a 00                	push   $0x0
8010633d:	68 bf 00 00 00       	push   $0xbf
80106342:	e9 b2 f3 ff ff       	jmp    801056f9 <alltraps>

80106347 <vector192>:
80106347:	6a 00                	push   $0x0
80106349:	68 c0 00 00 00       	push   $0xc0
8010634e:	e9 a6 f3 ff ff       	jmp    801056f9 <alltraps>

80106353 <vector193>:
80106353:	6a 00                	push   $0x0
80106355:	68 c1 00 00 00       	push   $0xc1
8010635a:	e9 9a f3 ff ff       	jmp    801056f9 <alltraps>

8010635f <vector194>:
8010635f:	6a 00                	push   $0x0
80106361:	68 c2 00 00 00       	push   $0xc2
80106366:	e9 8e f3 ff ff       	jmp    801056f9 <alltraps>

8010636b <vector195>:
8010636b:	6a 00                	push   $0x0
8010636d:	68 c3 00 00 00       	push   $0xc3
80106372:	e9 82 f3 ff ff       	jmp    801056f9 <alltraps>

80106377 <vector196>:
80106377:	6a 00                	push   $0x0
80106379:	68 c4 00 00 00       	push   $0xc4
8010637e:	e9 76 f3 ff ff       	jmp    801056f9 <alltraps>

80106383 <vector197>:
80106383:	6a 00                	push   $0x0
80106385:	68 c5 00 00 00       	push   $0xc5
8010638a:	e9 6a f3 ff ff       	jmp    801056f9 <alltraps>

8010638f <vector198>:
8010638f:	6a 00                	push   $0x0
80106391:	68 c6 00 00 00       	push   $0xc6
80106396:	e9 5e f3 ff ff       	jmp    801056f9 <alltraps>

8010639b <vector199>:
8010639b:	6a 00                	push   $0x0
8010639d:	68 c7 00 00 00       	push   $0xc7
801063a2:	e9 52 f3 ff ff       	jmp    801056f9 <alltraps>

801063a7 <vector200>:
801063a7:	6a 00                	push   $0x0
801063a9:	68 c8 00 00 00       	push   $0xc8
801063ae:	e9 46 f3 ff ff       	jmp    801056f9 <alltraps>

801063b3 <vector201>:
801063b3:	6a 00                	push   $0x0
801063b5:	68 c9 00 00 00       	push   $0xc9
801063ba:	e9 3a f3 ff ff       	jmp    801056f9 <alltraps>

801063bf <vector202>:
801063bf:	6a 00                	push   $0x0
801063c1:	68 ca 00 00 00       	push   $0xca
801063c6:	e9 2e f3 ff ff       	jmp    801056f9 <alltraps>

801063cb <vector203>:
801063cb:	6a 00                	push   $0x0
801063cd:	68 cb 00 00 00       	push   $0xcb
801063d2:	e9 22 f3 ff ff       	jmp    801056f9 <alltraps>

801063d7 <vector204>:
801063d7:	6a 00                	push   $0x0
801063d9:	68 cc 00 00 00       	push   $0xcc
801063de:	e9 16 f3 ff ff       	jmp    801056f9 <alltraps>

801063e3 <vector205>:
801063e3:	6a 00                	push   $0x0
801063e5:	68 cd 00 00 00       	push   $0xcd
801063ea:	e9 0a f3 ff ff       	jmp    801056f9 <alltraps>

801063ef <vector206>:
801063ef:	6a 00                	push   $0x0
801063f1:	68 ce 00 00 00       	push   $0xce
801063f6:	e9 fe f2 ff ff       	jmp    801056f9 <alltraps>

801063fb <vector207>:
801063fb:	6a 00                	push   $0x0
801063fd:	68 cf 00 00 00       	push   $0xcf
80106402:	e9 f2 f2 ff ff       	jmp    801056f9 <alltraps>

80106407 <vector208>:
80106407:	6a 00                	push   $0x0
80106409:	68 d0 00 00 00       	push   $0xd0
8010640e:	e9 e6 f2 ff ff       	jmp    801056f9 <alltraps>

80106413 <vector209>:
80106413:	6a 00                	push   $0x0
80106415:	68 d1 00 00 00       	push   $0xd1
8010641a:	e9 da f2 ff ff       	jmp    801056f9 <alltraps>

8010641f <vector210>:
8010641f:	6a 00                	push   $0x0
80106421:	68 d2 00 00 00       	push   $0xd2
80106426:	e9 ce f2 ff ff       	jmp    801056f9 <alltraps>

8010642b <vector211>:
8010642b:	6a 00                	push   $0x0
8010642d:	68 d3 00 00 00       	push   $0xd3
80106432:	e9 c2 f2 ff ff       	jmp    801056f9 <alltraps>

80106437 <vector212>:
80106437:	6a 00                	push   $0x0
80106439:	68 d4 00 00 00       	push   $0xd4
8010643e:	e9 b6 f2 ff ff       	jmp    801056f9 <alltraps>

80106443 <vector213>:
80106443:	6a 00                	push   $0x0
80106445:	68 d5 00 00 00       	push   $0xd5
8010644a:	e9 aa f2 ff ff       	jmp    801056f9 <alltraps>

8010644f <vector214>:
8010644f:	6a 00                	push   $0x0
80106451:	68 d6 00 00 00       	push   $0xd6
80106456:	e9 9e f2 ff ff       	jmp    801056f9 <alltraps>

8010645b <vector215>:
8010645b:	6a 00                	push   $0x0
8010645d:	68 d7 00 00 00       	push   $0xd7
80106462:	e9 92 f2 ff ff       	jmp    801056f9 <alltraps>

80106467 <vector216>:
80106467:	6a 00                	push   $0x0
80106469:	68 d8 00 00 00       	push   $0xd8
8010646e:	e9 86 f2 ff ff       	jmp    801056f9 <alltraps>

80106473 <vector217>:
80106473:	6a 00                	push   $0x0
80106475:	68 d9 00 00 00       	push   $0xd9
8010647a:	e9 7a f2 ff ff       	jmp    801056f9 <alltraps>

8010647f <vector218>:
8010647f:	6a 00                	push   $0x0
80106481:	68 da 00 00 00       	push   $0xda
80106486:	e9 6e f2 ff ff       	jmp    801056f9 <alltraps>

8010648b <vector219>:
8010648b:	6a 00                	push   $0x0
8010648d:	68 db 00 00 00       	push   $0xdb
80106492:	e9 62 f2 ff ff       	jmp    801056f9 <alltraps>

80106497 <vector220>:
80106497:	6a 00                	push   $0x0
80106499:	68 dc 00 00 00       	push   $0xdc
8010649e:	e9 56 f2 ff ff       	jmp    801056f9 <alltraps>

801064a3 <vector221>:
801064a3:	6a 00                	push   $0x0
801064a5:	68 dd 00 00 00       	push   $0xdd
801064aa:	e9 4a f2 ff ff       	jmp    801056f9 <alltraps>

801064af <vector222>:
801064af:	6a 00                	push   $0x0
801064b1:	68 de 00 00 00       	push   $0xde
801064b6:	e9 3e f2 ff ff       	jmp    801056f9 <alltraps>

801064bb <vector223>:
801064bb:	6a 00                	push   $0x0
801064bd:	68 df 00 00 00       	push   $0xdf
801064c2:	e9 32 f2 ff ff       	jmp    801056f9 <alltraps>

801064c7 <vector224>:
801064c7:	6a 00                	push   $0x0
801064c9:	68 e0 00 00 00       	push   $0xe0
801064ce:	e9 26 f2 ff ff       	jmp    801056f9 <alltraps>

801064d3 <vector225>:
801064d3:	6a 00                	push   $0x0
801064d5:	68 e1 00 00 00       	push   $0xe1
801064da:	e9 1a f2 ff ff       	jmp    801056f9 <alltraps>

801064df <vector226>:
801064df:	6a 00                	push   $0x0
801064e1:	68 e2 00 00 00       	push   $0xe2
801064e6:	e9 0e f2 ff ff       	jmp    801056f9 <alltraps>

801064eb <vector227>:
801064eb:	6a 00                	push   $0x0
801064ed:	68 e3 00 00 00       	push   $0xe3
801064f2:	e9 02 f2 ff ff       	jmp    801056f9 <alltraps>

801064f7 <vector228>:
801064f7:	6a 00                	push   $0x0
801064f9:	68 e4 00 00 00       	push   $0xe4
801064fe:	e9 f6 f1 ff ff       	jmp    801056f9 <alltraps>

80106503 <vector229>:
80106503:	6a 00                	push   $0x0
80106505:	68 e5 00 00 00       	push   $0xe5
8010650a:	e9 ea f1 ff ff       	jmp    801056f9 <alltraps>

8010650f <vector230>:
8010650f:	6a 00                	push   $0x0
80106511:	68 e6 00 00 00       	push   $0xe6
80106516:	e9 de f1 ff ff       	jmp    801056f9 <alltraps>

8010651b <vector231>:
8010651b:	6a 00                	push   $0x0
8010651d:	68 e7 00 00 00       	push   $0xe7
80106522:	e9 d2 f1 ff ff       	jmp    801056f9 <alltraps>

80106527 <vector232>:
80106527:	6a 00                	push   $0x0
80106529:	68 e8 00 00 00       	push   $0xe8
8010652e:	e9 c6 f1 ff ff       	jmp    801056f9 <alltraps>

80106533 <vector233>:
80106533:	6a 00                	push   $0x0
80106535:	68 e9 00 00 00       	push   $0xe9
8010653a:	e9 ba f1 ff ff       	jmp    801056f9 <alltraps>

8010653f <vector234>:
8010653f:	6a 00                	push   $0x0
80106541:	68 ea 00 00 00       	push   $0xea
80106546:	e9 ae f1 ff ff       	jmp    801056f9 <alltraps>

8010654b <vector235>:
8010654b:	6a 00                	push   $0x0
8010654d:	68 eb 00 00 00       	push   $0xeb
80106552:	e9 a2 f1 ff ff       	jmp    801056f9 <alltraps>

80106557 <vector236>:
80106557:	6a 00                	push   $0x0
80106559:	68 ec 00 00 00       	push   $0xec
8010655e:	e9 96 f1 ff ff       	jmp    801056f9 <alltraps>

80106563 <vector237>:
80106563:	6a 00                	push   $0x0
80106565:	68 ed 00 00 00       	push   $0xed
8010656a:	e9 8a f1 ff ff       	jmp    801056f9 <alltraps>

8010656f <vector238>:
8010656f:	6a 00                	push   $0x0
80106571:	68 ee 00 00 00       	push   $0xee
80106576:	e9 7e f1 ff ff       	jmp    801056f9 <alltraps>

8010657b <vector239>:
8010657b:	6a 00                	push   $0x0
8010657d:	68 ef 00 00 00       	push   $0xef
80106582:	e9 72 f1 ff ff       	jmp    801056f9 <alltraps>

80106587 <vector240>:
80106587:	6a 00                	push   $0x0
80106589:	68 f0 00 00 00       	push   $0xf0
8010658e:	e9 66 f1 ff ff       	jmp    801056f9 <alltraps>

80106593 <vector241>:
80106593:	6a 00                	push   $0x0
80106595:	68 f1 00 00 00       	push   $0xf1
8010659a:	e9 5a f1 ff ff       	jmp    801056f9 <alltraps>

8010659f <vector242>:
8010659f:	6a 00                	push   $0x0
801065a1:	68 f2 00 00 00       	push   $0xf2
801065a6:	e9 4e f1 ff ff       	jmp    801056f9 <alltraps>

801065ab <vector243>:
801065ab:	6a 00                	push   $0x0
801065ad:	68 f3 00 00 00       	push   $0xf3
801065b2:	e9 42 f1 ff ff       	jmp    801056f9 <alltraps>

801065b7 <vector244>:
801065b7:	6a 00                	push   $0x0
801065b9:	68 f4 00 00 00       	push   $0xf4
801065be:	e9 36 f1 ff ff       	jmp    801056f9 <alltraps>

801065c3 <vector245>:
801065c3:	6a 00                	push   $0x0
801065c5:	68 f5 00 00 00       	push   $0xf5
801065ca:	e9 2a f1 ff ff       	jmp    801056f9 <alltraps>

801065cf <vector246>:
801065cf:	6a 00                	push   $0x0
801065d1:	68 f6 00 00 00       	push   $0xf6
801065d6:	e9 1e f1 ff ff       	jmp    801056f9 <alltraps>

801065db <vector247>:
801065db:	6a 00                	push   $0x0
801065dd:	68 f7 00 00 00       	push   $0xf7
801065e2:	e9 12 f1 ff ff       	jmp    801056f9 <alltraps>

801065e7 <vector248>:
801065e7:	6a 00                	push   $0x0
801065e9:	68 f8 00 00 00       	push   $0xf8
801065ee:	e9 06 f1 ff ff       	jmp    801056f9 <alltraps>

801065f3 <vector249>:
801065f3:	6a 00                	push   $0x0
801065f5:	68 f9 00 00 00       	push   $0xf9
801065fa:	e9 fa f0 ff ff       	jmp    801056f9 <alltraps>

801065ff <vector250>:
801065ff:	6a 00                	push   $0x0
80106601:	68 fa 00 00 00       	push   $0xfa
80106606:	e9 ee f0 ff ff       	jmp    801056f9 <alltraps>

8010660b <vector251>:
8010660b:	6a 00                	push   $0x0
8010660d:	68 fb 00 00 00       	push   $0xfb
80106612:	e9 e2 f0 ff ff       	jmp    801056f9 <alltraps>

80106617 <vector252>:
80106617:	6a 00                	push   $0x0
80106619:	68 fc 00 00 00       	push   $0xfc
8010661e:	e9 d6 f0 ff ff       	jmp    801056f9 <alltraps>

80106623 <vector253>:
80106623:	6a 00                	push   $0x0
80106625:	68 fd 00 00 00       	push   $0xfd
8010662a:	e9 ca f0 ff ff       	jmp    801056f9 <alltraps>

8010662f <vector254>:
8010662f:	6a 00                	push   $0x0
80106631:	68 fe 00 00 00       	push   $0xfe
80106636:	e9 be f0 ff ff       	jmp    801056f9 <alltraps>

8010663b <vector255>:
8010663b:	6a 00                	push   $0x0
8010663d:	68 ff 00 00 00       	push   $0xff
80106642:	e9 b2 f0 ff ff       	jmp    801056f9 <alltraps>
...
8010674d:	68 4c 78 10 80       	push   $0x8010784c
...
8010681a:	c7 80 98 29 11 80 ff 	movl   $0xffff,-0x7feed668(%eax)
80106821:	ff 00 00 
80106824:	c7 80 9c 29 11 80 00 	movl   $0xcf9a00,-0x7feed664(%eax)
8010682b:	9a cf 00 
8010682e:	c7 80 a0 29 11 80 ff 	movl   $0xffff,-0x7feed660(%eax)
80106835:	ff 00 00 
80106838:	c7 80 a4 29 11 80 00 	movl   $0xcf9200,-0x7feed65c(%eax)
8010683f:	92 cf 00 
80106842:	c7 80 a8 29 11 80 ff 	movl   $0xffff,-0x7feed658(%eax)
80106849:	ff 00 00 
8010684c:	c7 80 ac 29 11 80 00 	movl   $0xcffa00,-0x7feed654(%eax)
80106853:	fa cf 00 
80106856:	c7 80 b0 29 11 80 ff 	movl   $0xffff,-0x7feed650(%eax)
8010685d:	ff 00 00 
80106860:	c7 80 b4 29 11 80 00 	movl   $0xcff200,-0x7feed64c(%eax)
80106867:	f2 cf 00 
8010686a:	05 90 29 11 80       	add    $0x80112990,%eax
...
80106890 <switchkvm>:
80106890:	a1 44 56 11 80       	mov    0x80115644,%eax
...
801069ef:	e8 1c db ff ff       	call   80104510 <memset>
801069f4:	58                   	pop    %eax
...
80106a1f:	5f                   	pop    %edi
80106a20:	5d                   	pop    %ebp
80106a21:	e9 9a db ff ff       	jmp    801045c0 <memmove>
80106a26:	83 ec 0c             	sub    $0xc,%esp
80106a29:	68 91 78 10 80       	push   $0x80107891
...
80106add:	68 ab 78 10 80       	push   $0x801078ab
80106ae2:	e8 a9 98 ff ff       	call   80100390 <panic>
80106ae7:	83 ec 0c             	sub    $0xc,%esp
80106aea:	68 4c 79 10 80       	push   $0x8010794c
...
80106b4b:	e8 c0 d9 ff ff       	call   80104510 <memset>
80106b50:	58                   	pop    %eax
...
80106b8d:	68 c9 78 10 80       	push   $0x801078c9
...
80106bc3:	68 e1 78 10 80       	push   $0x801078e1
...
80106ccc:	68 fd 78 10 80       	push   $0x801078fd
...
80106d00:	e8 0b d8 ff ff       	call   80104510 <memset>
...
80106d6b:	a3 44 56 11 80       	mov    %eax,0x80115644
...
80106d9f:	68 0e 79 10 80       	push   $0x8010790e
...
80106df0:	e8 cb d7 ff ff       	call   801045c0 <memmove>
80106df5:	58                   	pop    %eax
...
80106e89:	68 32 79 10 80       	push   $0x80107932
80106e8e:	e8 fd 94 ff ff       	call   80100390 <panic>
80106e93:	83 ec 0c             	sub    $0xc,%esp
80106e96:	68 18 79 10 80       	push   $0x80107918
...
80106f1f:	e8 9c d6 ff ff       	call   801045c0 <memmove>
