...
int main (int argc, char* argv[]) {
  ...
  24:	83 fb 09             	cmp    $0x9,%ebx
  27:	75 ef                	jne    18 <main+0x18>
            break;
    }

    fib(idx * 4);
  29:	bb 24 00 00 00       	mov    $0x24,%ebx
  2e:	66 90                	xchg   %ax,%ax
        return(fib(n - 1) + fib(n - 2));
  30:	8d 43 ff             	lea    -0x1(%ebx),%eax
  33:	83 ec 0c             	sub    $0xc,%esp
  36:	83 eb 02             	sub    $0x2,%ebx
  39:	50                   	push   %eax
  3a:	e8 41 00 00 00       	call   80 <fib>
  3f:	83 c4 10             	add    $0x10,%esp
    if (n == 0 || n == 1)
  42:	83 fb 01             	cmp    $0x1,%ebx
  45:	7f e9                	jg     30 <main+0x30>
    barrier();
  47:	bb 09 00 00 00       	mov    $0x9,%ebx
  4c:	e8 81 03 00 00       	call   3d2 <barrier>
  ...
  60:	75 f6                	jne    58 <main+0x58>
    ...
    exit();
  62:	e8 bb 02 00 00       	call   322 <exit>
    fib(idx * 4);
  67:	c1 e3 02             	shl    $0x2,%ebx
    if (n == 0 || n == 1)
  6a:	83 fb 01             	cmp    $0x1,%ebx
  6d:	7f c1                	jg     30 <main+0x30>
  6f:	eb d6                	jmp    47 <main+0x47>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
...
int fib(int n) {
  ...
  8e:	8b 55 08             	mov    0x8(%ebp),%edx
    if (n == 0 || n == 1)
  91:	83 fa 01             	cmp    $0x1,%edx
  94:	76 28                	jbe    be <fib+0x3e>
  96:	8d 7a fd             	lea    -0x3(%edx),%edi
  99:	8d 5a ff             	lea    -0x1(%edx),%ebx
  9c:	83 ea 02             	sub    $0x2,%edx
  9f:	83 e2 fe             	and    $0xfffffffe,%edx
  a2:	31 f6                	xor    %esi,%esi
  a4:	29 d7                	sub    %edx,%edi
        return(fib(n - 1) + fib(n - 2));
  ...
  bb:	8d 46 01             	lea    0x1(%esi),%eax
}
  be:	8d 65 f4             	lea    -0xc(%ebp),%esp
  c1:	5b                   	pop    %ebx
  c2:	5e                   	pop    %esi
  c3:	5f                   	pop    %edi
  c4:	5d                   	pop    %ebp
